...
import 'package:chess_bot/wholeproject/More/payment_webview.dart';
import 'package:chess_bot/wholeproject/constant.dart';
import 'package:chess_bot/wholeproject/constwidget/upi/upi_app.dart';
import 'package:chess_bot/wholeproject/constwidget/upi/upi_exception.dart';
import 'package:chess_bot/wholeproject/constwidget/upi/upi_india.dart';
import 'package:chess_bot/wholeproject/constwidget/upi/upi_response.dart';
...
class _DepositPageState extends State<DepositPage> {
  ...
  //   final amount = double.parse(rupee);
  //   return _upiIndia.startTransaction(
  //     app: app,
  //     receiverUpiId: "getepay.mbandhan77731@icici",
  //     receiverName: 'Sarkar Point',
  //     transactionRefId: 'TestingUpiIndiaPlugin',
  //     transactionNote: 'Pay In',
  //     amount: amount,
  //   );
  // }
  //
  ...
  //                               url:
  //                               "https://nk.wishufashion.com/phonepay/amount.php?auth=NTM1NDU0MzUyNDUyNDM1NjQyMzY1Mg==&name=test&mobile=12345678900&amount=${rupees.text}&orderid=$randomNumber&userid=$userid&paytype=101&redirecturl=bb",
  //                             )));
  //                     // Deposit(rupees.text,);
  //                   }
  //                       : () {
    ...
    return Scaffold(
      ...
      body: Form(
        ...
        child: Column(
                ...
                child: ElevatedButton(
                    onPressed: () async{
                      if (_formKey.currentState.validate()) {
                        final am=rupees.text;
                        final prefs = await SharedPreferences.getInstance();
                        final userid=prefs.getString("userId");
                        Navigator.push(context, MaterialPageRoute(builder:
                            (context)=>payment_Web(url:'https://apponrent.co.in/chess/final_payment/Payment_Gateway/index.php?txnAmount=$am&userid=$userid')));
          ...
          //       print("step 1 doneeee");
          //       if (snapshot.connectionState == ConnectionState.done) {
          //
          //         print("step 2 doneeee");
          //         if (snapshot.hasError) {
          //           print("step 3 doneeee");
          //           return Center(
          //             child: Text(
  ...
  Widget buildTextField(width, height) {
      ...
      child: TextFormField(
        ...
        validator:  (value) {
          ...
          if (double.tryParse(value) == null || double.parse(value) >= 0) {
            return "Minimum Add Amount is ₹50";
          }
    ...
    //             return 'Please enter an amount.';
    //           }
    //           if (double.tryParse(value) == null || double.parse(value) >= 2) {
    //             return 'Amount must be a valid number less than 50.';
    //           }
    //
    //           return null;
