...
import 'package:chess_bot/MainGameModel/PlayWithOnline/chess_board/src/chess_board.dart';
...
import 'package:chess_bot/MainGameModel/PlayWithOnline/chess_board/src/chess_board_controller.dart';
import 'package:chess_bot/MainGameModel/PlayWithOnline/chess_board/src/chess_sub.dart';
import 'package:chess_bot/MainGameModel/PlayWithOnline/eval/ai.dart';
...
import 'package:chess_bot/wholeproject/home/drawpage.dart';
...
class ChessController {
  ...
  void onMove(move) {
       ...
       sound(audio: "assets/audio/pownsound.mp3");
  ...
  bool makeBotMoveIfRequired() {
    ...
    //make move if needed
    // double chess gotty image render problem
  ...
  void onDraw() {
    Navigator.push(context, MaterialPageRoute(builder: (context)=>Draw_page()));
    //show the dialog
    // showAnimatedDialog(
    //     title: strings.draw,
  ...
  void onCheckMate(color) {
    ...
    print(loser);
    print(strings.white);
    Navigator.push(context, MaterialPageRoute(builder: (context)=>Winner_page(looser:loser==strings.white?'id':'oid')));
    // showAnimatedDialog(
  ...
  void onCheck(color) {
    sounds(audio: "assets/audio/checkandmate.mp3");
    print('onCheck');
  }
