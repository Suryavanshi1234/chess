...
String _createGameCode(String gameCode) {
...
String joinGameCodeWithoutFirebaseCreation({String gameCode}) {
  if (gameCode != 0)
    ...
    return _currentGameCode = _createGameCode(gameCode);
}
...
class OnlineGameController {
  ...
  void finallyCreateGameCode(String gameCode) {
    //create new game id locally
    String gameId = joinGameCodeWithoutFirebaseCreation(gameCode:gameCode);
